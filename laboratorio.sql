...
ALTER TABLE `equipamento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `departamento_equipamento` (`iddepartamento`);
...
--
ALTER TABLE `equipamento`
  ADD CONSTRAINT `departamento_equipamento` FOREIGN KEY (`iddepartamento`) REFERENCES `departamento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `inventario`
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `equipamento_inventario` FOREIGN KEY (`equipamento`) REFERENCES `inventario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
